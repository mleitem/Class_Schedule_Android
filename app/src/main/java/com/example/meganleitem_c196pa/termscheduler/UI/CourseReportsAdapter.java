...
public class CourseReportsAdapter extends RecyclerView.Adapter<CourseReportsAdapter.CourseViewHolder> {
        ...
        private CourseViewHolder(View itemView){
            ...
            itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, CourseReports.class);
    ...
    public CourseReportsAdapter(Context context){
    ...
    @NonNull
    @Override
    public CourseReportsAdapter.CourseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = mInflater.inflate(R.layout.course_list_item, parent, false);
        return new CourseReportsAdapter.CourseViewHolder(itemView);
    }

    //Put things on the text view
    @Override
    public void onBindViewHolder(@NonNull CourseReportsAdapter.CourseViewHolder holder, int position) {
        if(mCourses != null){
